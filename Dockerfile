...
RUN echo "deb https://artifacts.elastic.co/packages/8.x/apt stable main" | tee -a /etc/apt/sources.list.d/elastic-6.x.list
...
RUN cp logstash.conf /usr/share/logstash/